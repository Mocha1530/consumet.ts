...
- fix(MangaKakalot): switch to API-based chapter fetching [`#751`](https://github.com/consumet/consumet.ts/pull/751)
- fix: animesama & got-scraping dep [`#747`](https://github.com/consumet/consumet.ts/pull/747)
- feat(movies): Add NetMirror provider for Netflix/Prime/Disney+/Lionsgate content [`#746`](https://github.com/consumet/consumet.ts/pull/746)
- Bump version [`#745`](https://github.com/consumet/consumet.ts/pull/745)
- fix: update mangakakalot selectors for latest website structure [`#744`](https://github.com/consumet/consumet.ts/pull/744)
-  Adding FrenchProvider and New extractors #738  [`#739`](https://github.com/consumet/consumet.ts/pull/739)
- refactor(anilist): improve anime title matching with similarity scoring [`#737`](https://github.com/consumet/consumet.ts/pull/737)
- build(deps): bump actions/cache from 3 to 4 [`#732`](https://github.com/consumet/consumet.ts/pull/732)
- build(deps): bump appleboy/ssh-action from 1.0.0 to 1.2.3 [`#733`](https://github.com/consumet/consumet.ts/pull/733)
- Nerds branch [`#731`](https://github.com/consumet/consumet.ts/pull/731)
- feat: add preview API deployment workflow [`#716`](https://github.com/consumet/consumet.ts/pull/716)
- feat(provider): MangaHere [`#728`](https://github.com/consumet/consumet.ts/pull/728)
- Build fixes [`#729`](https://github.com/consumet/consumet.ts/pull/729)
- feat(provider): AnimePahe: MP4 DDL  [`#722`](https://github.com/consumet/consumet.ts/pull/722)
- Add comprehensive GitHub Copilot instructions for consumet.ts development [`#705`](https://github.com/consumet/consumet.ts/pull/705)
- Yarn fixes [`#727`](https://github.com/consumet/consumet.ts/pull/727)
- fix: Improve Yarn caching logic in CI workflow [`#18`](https://github.com/consumet/consumet.ts/pull/18)
- fix: yarn fixes (v1.1) [`#17`](https://github.com/consumet/consumet.ts/pull/17)
- fix: nodejs cli [`#16`](https://github.com/consumet/consumet.ts/pull/16)
- chore(security): Removing eval() on packer decoding [`#723`](https://github.com/consumet/consumet.ts/pull/723)
- feat(provider): AnimePahe: fetchRecentEpisodes [`#720`](https://github.com/consumet/consumet.ts/pull/720)
- Nerds branch [`#721`](https://github.com/consumet/consumet.ts/pull/721)
- Nerds branch [`#719`](https://github.com/consumet/consumet.ts/pull/719)
- fix(workflow): improve build workflow with change detection and improved security [`#715`](https://github.com/consumet/consumet.ts/pull/715)
- feat(anilist): add fetchFavoriteList method [`#714`](https://github.com/consumet/consumet.ts/pull/714)
- build(deps): bump actions/setup-node from 4.0.3 to 4.1.0 [`#595`](https://github.com/consumet/consumet.ts/pull/595)
- update: add animeunity provider [`#713`](https://github.com/consumet/consumet.ts/pull/713)
- refactor: update anime tests [`#712`](https://github.com/consumet/consumet.ts/pull/712)
- Update providers status repo link [`#711`](https://github.com/consumet/consumet.ts/pull/711)
- Update providers status repo link [`#13`](https://github.com/consumet/consumet.ts/pull/13)
- Feat/clean and fix stuff [`#12`](https://github.com/consumet/consumet.ts/pull/12)
- Feat/clean and fix stuff [`#710`](https://github.com/consumet/consumet.ts/pull/710)
- update movie providers [`#11`](https://github.com/consumet/consumet.ts/pull/11)
- Nerds branch [`#10`](https://github.com/consumet/consumet.ts/pull/10)
- Feat/clean and fix stuff [`#9`](https://github.com/consumet/consumet.ts/pull/9)
- fix: update movie providers [`#8`](https://github.com/consumet/consumet.ts/pull/8)
- refactor: relink to a working provider status [`#7`](https://github.com/consumet/consumet.ts/pull/7)
- fix: some more cleaning [`#6`](https://github.com/consumet/consumet.ts/pull/6)
- Nerds branch [`#5`](https://github.com/consumet/consumet.ts/pull/5)
- refactor: Update files and remove broken providers [`#4`](https://github.com/consumet/consumet.ts/pull/4)
- Feat/clean and fix stuff [`#3`](https://github.com/consumet/consumet.ts/pull/3)
- feat(provider): add manga provider weebcentral [`#709`](https://github.com/consumet/consumet.ts/pull/709)
- fix(megaup|animekai): update megaup extractor to use external api for  iframe decoding [`#708`](https://github.com/consumet/consumet.ts/pull/708)
- fix: update comick and add documentation page [`#707`](https://github.com/consumet/consumet.ts/pull/707)
- feat: add manga provider &gt; weebcentral [`#1`](https://github.com/consumet/consumet.ts/pull/1)
- feat: update extractors, episode ID parsing, and sort logic for bette… [`#698`](https://github.com/consumet/consumet.ts/pull/698)
- change the domain of animepahe.ru to animepahe.si [`#703`](https://github.com/consumet/consumet.ts/pull/703)
- feat(provider): add AnimeOwl with Luffy extractor integration [`#697`](https://github.com/consumet/consumet.ts/pull/697)
- Revert back to hianime.to because its back [`#691`](https://github.com/consumet/consumet.ts/pull/691)
- feat(himovies): a new movie provider [`#685`](https://github.com/consumet/consumet.ts/pull/685)
- feat(netflixmirror): new movie provider [`#681`](https://github.com/consumet/consumet.ts/pull/681)
- feat(animepahe): download links [`#671`](https://github.com/consumet/consumet.ts/pull/671)
- fix(multimovies | streamwish): update multimovies's url and regex fix in streamwish [`#678`](https://github.com/consumet/consumet.ts/pull/678)
- feat(animekai): refactor decryption to use external source with auto-updating keys [`#679`](https://github.com/consumet/consumet.ts/pull/679)
- feat(animepahe): external links for animepahe [`#677`](https://github.com/consumet/consumet.ts/pull/677)
- fix(megaup): refactor decoding logic [`#675`](https://github.com/consumet/consumet.ts/pull/675)
- fix(anime): add headers in zoro and download url in animekai [`#674`](https://github.com/consumet/consumet.ts/pull/674)
- fix(kwik): update host URL and refactor data extraction method [`#667`](https://github.com/consumet/consumet.ts/pull/667)
- fix (megaup): extractor [`#666`](https://github.com/consumet/consumet.ts/pull/666)
- feat(animekai|voe): add recently updated anime & subtitles [`#665`](https://github.com/consumet/consumet.ts/pull/665)
- feat(zoro): add advanced search [`#664`](https://github.com/consumet/consumet.ts/pull/664)
- fix: Animekai [`#661`](https://github.com/consumet/consumet.ts/pull/661)
- fix(voe): minor encryption fix [`#662`](https://github.com/consumet/consumet.ts/pull/662)
- fix(animekai): add custom headers for requests [`#660`](https://github.com/consumet/consumet.ts/pull/660)
- feat(zoro): add fetchWatchList [`#658`](https://github.com/consumet/consumet.ts/pull/658)
- fix(animepahe | animekai): added headers to animepahe and fix id in animekai [`#657`](https://github.com/consumet/consumet.ts/pull/657)
- fix(filemoon): Update extractor logic to latest filemoon changes [`#655`](https://github.com/consumet/consumet.ts/pull/655)
- feat(animekai):Add provider + fix(zoro | multimovies): multimovies to work with tmdb & zoro to provide proper sub and dub sources [`#656`](https://github.com/consumet/consumet.ts/pull/656)
- feat(animekai | kisskh): Added Animekai and kisskh decoders [`#650`](https://github.com/consumet/consumet.ts/pull/650)
- feat(zoro): Add status, genres, season and japaneseTitle to fetchAnimeInfo [`#644`](https://github.com/consumet/consumet.ts/pull/644)
- fix(dramacool | multimovies): change in scraping logic for dramacool due to change in baseUrl, update baseURL of multimovies and improve server fetching logic. [`#651`](https://github.com/consumet/consumet.ts/pull/651)
- fix(flixhq) [`#635`](https://github.com/consumet/consumet.ts/pull/635)
- feat(multimovies): add new movie provider for Indian languages support in movies/anime [`#633`](https://github.com/consumet/consumet.ts/pull/633)
- fix(dramacool): update domain [`#643`](https://github.com/consumet/consumet.ts/pull/643)
- fix(zoro): fixed not fetching newer episodes [`#646`](https://github.com/consumet/consumet.ts/pull/646)
- feat(anix): Add fetch random anime [`#632`](https://github.com/consumet/consumet.ts/pull/632)
- fix: AnimeUnity sources [`#631`](https://github.com/consumet/consumet.ts/pull/631)
- fix(megacloud):  extractor [`#630`](https://github.com/consumet/consumet.ts/pull/630)
- feat+fix(Anix): fetchEpisodeServerType & fetchEpisodeSources [`#629`](https://github.com/consumet/consumet.ts/pull/629)
- feat(vidhide): Add extractor vidhide + feat(anix): Add vidhide streaming server on fetchEpisodeSources [`#628`](https://github.com/consumet/consumet.ts/pull/628)
- fix(Asurascans): chapters [`#627`](https://github.com/consumet/consumet.ts/pull/627)
- fix(anix): Change Referer header to mp4upload url to bypass 403 forbidden [`#625`](https://github.com/consumet/consumet.ts/pull/625)
- fix(anix): MP4Upload empty streams [`#622`](https://github.com/consumet/consumet.ts/pull/622)
- fix(streamwish): update searchParams to &i=0.4 to fix 403 error feat(movies): add fetchSpotlight to some providers [`#620`](https://github.com/consumet/consumet.ts/pull/620)
- feat(anix): Add type selector for fetchRecentEpisodes, better readability and preparation for future advanced search [`#618`](https://github.com/consumet/consumet.ts/pull/618)
- Fix TypeScript error TS2322 in proxy interceptor [`#617`](https://github.com/consumet/consumet.ts/pull/617)
- feat(anix): Add new provider anix.to [`#615`](https://github.com/consumet/consumet.ts/pull/615)
- refactor(fmovies): update `baseUrl` [`#614`](https://github.com/consumet/consumet.ts/pull/614)
- fix(gogoanime): Removed trailing forward slash in baseUrl [`#612`](https://github.com/consumet/consumet.ts/pull/612)
- docs: Update README.md  [`#611`](https://github.com/consumet/consumet.ts/pull/611)
- chore: compile new changes [`#607`](https://github.com/consumet/consumet.ts/pull/607)
- fix(animefox): update domain animefox [`#608`](https://github.com/consumet/consumet.ts/pull/608)
- perf(gogocdn): Added null safety [`#606`](https://github.com/consumet/consumet.ts/pull/606)
- fix(proxy): fix an issue where an array is passed to the interceptor [`#603`](https://github.com/consumet/consumet.ts/pull/603)
- fix(mangakakalot): fix manga info and chapter fetch [`#598`](https://github.com/consumet/consumet.ts/pull/598)
- feat(extractors | providers): add subtitles(tracks) in some of the extractors so that thumbnail preview can be used when progressing using slider, add sflix provider in movies and streamwish extractor in dramacool [`#602`](https://github.com/consumet/consumet.ts/pull/602)
- fix(anilist): no episodes bug [`#596`](https://github.com/consumet/consumet.ts/pull/596)
- refactor(gogoanime): update Base URL to `anitaku.bz` [`#597`](https://github.com/consumet/consumet.ts/pull/597)
- feat(gogoanime)+fix(streamwish): Add Mp4Upload as server on fetchEpisodeSources & fix encoding error [`#592`](https://github.com/consumet/consumet.ts/pull/592)
- feat: Add MonosChinos provider + fix Voe Extractor [`#590`](https://github.com/consumet/consumet.ts/pull/590)
- fix(dramacool): media info description [`#591`](https://github.com/consumet/consumet.ts/pull/591)
- fix(streamwish): throwing 403 forbidden streams most of the time & proxy header issue in gogoanime [`#589`](https://github.com/consumet/consumet.ts/pull/589)
- fix(vidcloud): ensure isM3U8 property detects URLs ending with -m3u8 correctly [`#587`](https://github.com/consumet/consumet.ts/pull/587)
- refactor(streamwish): refactor streamWish decoding to get a proper HLS urls [`#585`](https://github.com/consumet/consumet.ts/pull/585)
- feat(zoro)+fix(anilist): new methods & fix type issue [`#584`](https://github.com/consumet/consumet.ts/pull/584)
- feat(zoro): added continue watching [`#582`](https://github.com/consumet/consumet.ts/pull/582)
- chore: Add Missing domhandler dep [`#581`](https://github.com/consumet/consumet.ts/pull/581)
- feat(animeunity)+fix(gogoanime): Add metadata to search & fix search release date [`#577`](https://github.com/consumet/consumet.ts/pull/577)
- fix(kitsu): Update Kitsu GraphQL and Media URLs to New Domain [`#576`](https://github.com/consumet/consumet.ts/pull/576)
- refactor(gogoanime): Optimize otherName algorithm anime info [`#573`](https://github.com/consumet/consumet.ts/pull/573)
- docs+fix(asurascans): remove cloudscraper [`#572`](https://github.com/consumet/consumet.ts/pull/572)
- feat: Add Vyvymanga provider [`#570`](https://github.com/consumet/consumet.ts/pull/570)
- fix(zoro + gogo): custom domain [`#571`](https://github.com/consumet/consumet.ts/pull/571)
- feat(anilist): Add staff fetching [`#567`](https://github.com/consumet/consumet.ts/pull/567)
- docs+fix(gogoanime): Update docs to include some new methods, anime title not being retrieved properly when " is included [`#568`](https://github.com/consumet/consumet.ts/pull/568)
- feat+docs(dramacool): Implemented fetchPopular and mediaInfo enhancements [`#565`](https://github.com/consumet/consumet.ts/pull/565)
- feat: Add animedrive.hu provider [`#555`](https://github.com/consumet/consumet.ts/pull/555)
- feat(mangadex): Add cover image from the search results [`#563`](https://github.com/consumet/consumet.ts/pull/563)
- fix(gogoanime): Download link not showing properly on other server+optimize header streamwish [`#564`](https://github.com/consumet/consumet.ts/pull/564)
- merge [`#4`](https://github.com/consumet/consumet.ts/pull/4)
- feat(anilist): update anify url [`#560`](https://github.com/consumet/consumet.ts/pull/560)
- feat: add readmanga.app provider [`#556`](https://github.com/consumet/consumet.ts/pull/556)
- fix(gogoanime): include brackets in subOrDub filter [`#557`](https://github.com/consumet/consumet.ts/pull/557)
- fix(anify): Change anify endpoint [`#558`](https://github.com/consumet/consumet.ts/pull/558)
- Merge [`#3`](https://github.com/consumet/consumet.ts/pull/3)
- Rabbitfix [`#542`](https://github.com/consumet/consumet.ts/pull/542)
- Fix(zoro): fetchEpisodeSources [`#543`](https://github.com/consumet/consumet.ts/pull/543)
- Rabbitfix [`#537`](https://github.com/consumet/consumet.ts/pull/537)
- fix(zoro): Resolve null banner issue in fetchSpotlight [`#538`](https://github.com/consumet/consumet.ts/pull/538)
- feat(zoro): Add search suggestions [`#536`](https://github.com/consumet/consumet.ts/pull/536)
- feat(AnimeUnity): Add more episode sources [`#535`](https://github.com/consumet/consumet.ts/pull/535)
- fix(tmdb): Allow a broader range of totalSeasons values [`#524`](https://github.com/consumet/consumet.ts/pull/524)
- fix: AnimeUnity episode sources [`#534`](https://github.com/consumet/consumet.ts/pull/534)
- fix(streamwish): Grab video sources extractor [`#529`](https://github.com/consumet/consumet.ts/pull/529)
- fix(gogoanime): title scrape in search() [`#530`](https://github.com/consumet/consumet.ts/pull/530)
- fix(gogoanime): update if-statement case for fetchDirectDownloadLink [`#527`](https://github.com/consumet/consumet.ts/pull/527)
- Merge [`#2`](https://github.com/consumet/consumet.ts/pull/2)
- feat: Add optional custom domain parameter for zoro & gogo [`#526`](https://github.com/consumet/consumet.ts/pull/526)
- fix(Megacloud): extracting needed vars [`#521`](https://github.com/consumet/consumet.ts/pull/521)
- fix(animesaturn): parsing [`#519`](https://github.com/consumet/consumet.ts/pull/519)
- fix extractor(MegaCloud): update regex for allvars [`#520`](https://github.com/consumet/consumet.ts/pull/520)
- refactor(gogoanime): Refactor fetchEpisodeSources [`#514`](https://github.com/consumet/consumet.ts/pull/514)
- fix(9anime): Update domain [`#510`](https://github.com/consumet/consumet.ts/pull/510)
- feat(gogoanime): get direct download links from download url [`#505`](https://github.com/consumet/consumet.ts/pull/505)
- build(deps): bump actions/setup-node from 4.0.1 to 4.0.2 [`#460`](https://github.com/consumet/consumet.ts/pull/460)
- fix(viewasian): streaming links issue [`#501`](https://github.com/consumet/consumet.ts/pull/501)
- Add turkish123 provider [`#499`](https://github.com/consumet/consumet.ts/pull/499)
- feat(zoro): Add additional meta data to fetchAnimeInfo [`#498`](https://github.com/consumet/consumet.ts/pull/498)
- refactor(zoro): QOL [`#496`](https://github.com/consumet/consumet.ts/pull/496)
- feat(gogoanime): add more meta data [`#494`](https://github.com/consumet/consumet.ts/pull/494)
- feat(zero): added fetchSpotlight  [`#495`](https://github.com/consumet/consumet.ts/pull/495)
- fix(comick): update domain [`#493`](https://github.com/consumet/consumet.ts/pull/493)
- feat(zoro): Fetch schedule for a given date [`#492`](https://github.com/consumet/consumet.ts/pull/492)
- fix(zoro): hasNextPage always being true [`#491`](https://github.com/consumet/consumet.ts/pull/491)
- feat(zoro): added fetchStudio [`#490`](https://github.com/consumet/consumet.ts/pull/490)
- fix(zoro): update the extractor in fetchEpisodeSources+ update zoro domain. [`#482`](https://github.com/consumet/consumet.ts/pull/482)
- fix(gogoanime): ajax url [`#485`](https://github.com/consumet/consumet.ts/pull/485)
- feat(mangadex): new endpoint added in mangadex [`#481`](https://github.com/consumet/consumet.ts/pull/481)
- feat(dramacool): add genres, duration, & status to fetchMediaInfo [`#479`](https://github.com/consumet/consumet.ts/pull/479)
- fix(AnimeUnity): fetching episodes metadata [`#473`](https://github.com/consumet/consumet.ts/pull/473)
- feat(flixhq): Add fetch by genre [`#476`](https://github.com/consumet/consumet.ts/pull/476)
- feat(gogoanime): Added Genres and Release Date for fetchAnimeList()+ Includes test [`#477`](https://github.com/consumet/consumet.ts/pull/477)
- feat(flixhq): add fetch by country [`#469`](https://github.com/consumet/consumet.ts/pull/469)
- fix(vidcloud): extract url source  [`#478`](https://github.com/consumet/consumet.ts/pull/478)
- fix(gogoanime): Parse episode number as a float  [`#474`](https://github.com/consumet/consumet.ts/pull/474)
- feat(gogoanime): Anime List [`#466`](https://github.com/consumet/consumet.ts/pull/466)
- fix(gogoanime): scraping text fields [`#472`](https://github.com/consumet/consumet.ts/pull/472)
- Switch rabbitstream keys back to github based [`#465`](https://github.com/consumet/consumet.ts/pull/465)
- Fixed rabbitstream keys [`#464`](https://github.com/consumet/consumet.ts/pull/464)
- fix(gogoanime): Update provider url to `https://gogoanime3.co/` [`#458`](https://github.com/consumet/consumet.ts/pull/458)
- Merge [`#1`](https://github.com/consumet/consumet.ts/pull/1)
- feat: Zoro extra functions [`#453`](https://github.com/consumet/consumet.ts/pull/453)
- feat(TMDB): Trending API [`#445`](https://github.com/consumet/consumet.ts/pull/445)
- Add AnimeUnity provider [`#449`](https://github.com/consumet/consumet.ts/pull/449)
- fix(util): fix null TypeError in getHashFromImage [`#446`](https://github.com/consumet/consumet.ts/pull/446)
- include outro when extracting from rapidcloud [`#448`](https://github.com/consumet/consumet.ts/pull/448)
- build(deps): bump actions/setup-node from 4.0.0 to 4.0.1 [`#443`](https://github.com/consumet/consumet.ts/pull/443)
- build(deps): bump github/codeql-action from 2 to 3 [`#442`](https://github.com/consumet/consumet.ts/pull/442)
- fix(blurhash): getHashFromImage method for generating blurhash [`#437`](https://github.com/consumet/consumet.ts/pull/437)
- Add blurhash support for anilist and anime news [`#435`](https://github.com/consumet/consumet.ts/pull/435)
- feat(gogoanime): Add fetch anime movies & popular anime [`#430`](https://github.com/consumet/consumet.ts/pull/430)
- docs(anime.md): fix typo [`#431`](https://github.com/consumet/consumet.ts/pull/431)
- feat(gogoanime): Fetch Genre List+move to gogoanime3.net temporarily [`#427`](https://github.com/consumet/consumet.ts/pull/427)
...
- I love enimax :) [`#307`](https://github.com/consumet/consumet.ts/pull/307)
...
- feat: Add MonosChinos provider + fix Voe Extractor (#590) [`#548`](https://github.com/consumet/consumet.ts/issues/548)
- feat(flixhq): Add fetch by genre (#476) [`#475`](https://github.com/consumet/consumet.ts/issues/475)
- fix(vidcloud): extract url source  (#478) [`#569`](https://github.com/consumet/consumet.ts/issues/569)
